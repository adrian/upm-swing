...
/**
 * This code was copied from Apache HTTPComponents 3.0 Contrib section.
 * 
 * http://svn.apache.org/viewvc/httpcomponents/oac.hc3x/tags/HTTPCLIENT_3_0/src/contrib/org/apache/commons/httpclient/contrib/ssl/StrictSSLProtocolSocketFactory.java?view=markup
 *
 * It's been customized for UPM to allow for an explicitly trusted hostname.
 * 
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * 
...
public class StrictSSLProtocolSocketFactory 
    ...
    /**
     * Provide a hostname to always trust regardless of the CN in the
     * certificate retrieved from that host.
     * 
     * @param trustedHostname The hostname to always trust
     */
    public StrictSSLProtocolSocketFactory(String trustedHostname) {
        super();
    ...
    private void verifyHostname(SSLSocket socket) 
        ...
        // Is this an explicitly trusted host?
